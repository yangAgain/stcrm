...
<table>
	<tr>
		<td><img src="${path }/images/logo.jpg"/></td>
		<td style="font-size: 20px;">信息管理系统</td>
		<td style="color: red;position: absolute;left: 1200px;top: 20px;">欢迎：${currentUser.userName }&nbsp;『${currentUser.roleName }』</td>
	</tr>
</table>
</div>
</div>
